...
<form id="form1" runat="server">
	...
	<asp:SqlDataSource id="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cm_dbConnectionString2 %>" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:cm_dbConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM  velo_users_moviestars " ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM  velo_users_moviestars  WHERE  id  = ? AND (( starid  = ?) OR ( starid  IS NULL AND ? IS NULL)) AND (( starbirthdayyear  = ?) OR ( starbirthdayyear  IS NULL AND ? IS NULL)) AND (( starname  = ?) OR ( starname  IS NULL AND ? IS NULL)) AND (( otherwork1  = ?) OR ( otherwork1  IS NULL AND ? IS NULL)) AND (( otherwork2  = ?) OR ( otherwork2  IS NULL AND ? IS NULL)) AND (( otherwork3  = ?) OR ( otherwork3  IS NULL AND ? IS NULL)) AND (( pictureurl  = ?) OR ( pictureurl  IS NULL AND ? IS NULL))" InsertCommand="INSERT INTO  velo_users_moviestars  ( id ,  starid ,  starbirthdayyear ,  starname ,  otherwork1 ,  otherwork2 ,  otherwork3 ,  pictureurl ) VALUES (?, ?, ?, ?, ?, ?, ?, ?)" UpdateCommand="UPDATE  velo_users_moviestars  SET  starid  = ?,  starbirthdayyear  = ?,  starname  = ?,  otherwork1  = ?,  otherwork2  = ?,  otherwork3  = ?,  pictureurl  = ? WHERE  id  = ? AND (( starid  = ?) OR ( starid  IS NULL AND ? IS NULL)) AND (( starbirthdayyear  = ?) OR ( starbirthdayyear  IS NULL AND ? IS NULL)) AND (( starname  = ?) OR ( starname  IS NULL AND ? IS NULL)) AND (( otherwork1  = ?) OR ( otherwork1  IS NULL AND ? IS NULL)) AND (( otherwork2  = ?) OR ( otherwork2  IS NULL AND ? IS NULL)) AND (( otherwork3  = ?) OR ( otherwork3  IS NULL AND ? IS NULL)) AND (( pictureurl  = ?) OR ( pictureurl  IS NULL AND ? IS NULL))">
		<DeleteParameters>
