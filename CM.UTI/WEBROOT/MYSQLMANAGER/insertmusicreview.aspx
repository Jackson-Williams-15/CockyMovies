...
<form id="form1" runat="server">
	<div class="auto-style1">
		...
		DRIVE<br>INSERT A NEW MUSIC REVIEW<div class="auto-style1">
		</div>
	</div>
	...
	<p class="auto-style1">
	<asp:DetailsView id="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="id" DataSourceID="SqlDataSource1" Height="50px" Width="622px" AllowPaging="True" horizontalalign="Center" EnableModelValidation="True">
		<Fields>
